...
const path = unit => `/152023730/demo/${unit}`;
...
module.exports = {
  default: {
    ...
    'load-more': { ...CONTENT, path: path('default_load-more') },
  ...
  automatizacion: {
    ...
    'load-more': { ...CONTENT, path: path('automatizacion_load-more') },
  ...
  empaque: {
    ...
    'load-more': { ...CONTENT, path: path('empaque_load-more') },
  ...
  procesamiento: {
    ...
    'load-more': { ...CONTENT, path: path('procesamiento_load-more') },
