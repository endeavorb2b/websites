...
const path = unit => `/21687441225/PMMI/AW/${unit}`;
...
module.exports = {
  ...
  // 'channel1': {
  //   lb1: { ...LB, path: path('channel1/lb1') },
  //   lb2: { ...LB, path: path('channel1/lb2') },
  //   rail1: { ...CONTENT, path: path('channel1/rail1') },
  //   rail2: { ...CONTENT, path: path('channel1/rail2') },
  //   'load-more': { ...CONTENT, path: path('channel1/load-more') },
  // },
};
